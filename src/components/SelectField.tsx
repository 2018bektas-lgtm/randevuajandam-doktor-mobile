...
const styles = StyleSheet.create({
  ...
  chevron: { color: '#F3A26B', fontSize: 16, fontWeight: '700' },
  overlay: {
    flex: 1,
  ...
  done: { color: '#F3A26B', fontSize: 14, fontWeight: '800' },
  clear: { color: '#94A7B9', fontSize: 13, fontWeight: '700' },
  search: {
    marginHorizontal: 16,
    marginTop: 12,
    borderRadius: 12,
  ...
  optionLabel: { color: '#E8F0F7', fontSize: 15, fontWeight: '700' },
  optionLabelOn: { color: '#FFFFFF' },
  optionSub: { color: '#94A7B9', fontSize: 12, marginTop: 3 },
  check: { color: '#5A7085', fontSize: 16, fontWeight: '700', minWidth: 22, textAlign: 'right' },
  checkOn: { color: '#F3A26B' },
  empty: {
    color: '#94A7B9',
    textAlign: 'center',
    marginTop: 28,
