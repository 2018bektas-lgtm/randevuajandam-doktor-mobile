...
const styles = StyleSheet.create({
  ...
  metricHint: { color: '#94A3B8', fontSize: 11, marginTop: 4 },
  ...
  softActionText: { fontSize: 13, fontWeight: '700' },
  appt: {
    flexDirection: 'row',
    backgroundColor: '#FFFFFF',
    borderRadius: 18,
  ...
  apptTimeBlock: { flexDirection: 'row', alignItems: 'center', gap: 6, flexShrink: 1 },
  apptTime: {
    color: '#0F172A',
    fontSize: 15,
    fontWeight: '700',
  ...
  apptDate: { color: '#94A3B8', fontSize: 12, fontWeight: '600' },
  apptPatient: {
    marginTop: 8,
    color: '#0F172A',
    fontSize: 17,
  ...
  apptMetaItem: { flexDirection: 'row', alignItems: 'center', gap: 4, maxWidth: '100%' },
  apptMetaText: { color: '#64748B', fontSize: 12, fontWeight: '500' },
  apptActions: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    gap: 8,
